...
import Rent_addhouse from '@/views/rent_addhouse'
import Rent_contract_change from '@/views/rent_contract_change'
      ...
      children: [
        {
          path:'rent_addhouse',
          name:'Rent_addhouse',
          component:Rent_addhouse,
        },
        {
          path: 'Rent_contract_change',
          name: 'Rent_contract_change',
          component: Rent_contract_change
        }
      ]
    },
    //收费管理
